...
class StripeChargeSucceededEvent(AbstractStripeWebhookEvent):
    ...
    def run(self):
        ...
        sfd["card_last4"] = d["data"]["object"]["payment_method_details"]["card"]["last4"]
        sfd["card_brand"] = d["data"]["object"]["payment_method_details"]["card"]["brand"]
        sfd["card_exp_month"] = d["data"]["object"]["payment_method_details"]["card"]["exp_month"]
        sfd["card_exp_year"] = d["data"]["object"]["payment_method_details"]["card"]["exp_year"]
