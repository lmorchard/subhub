...
def test_stripe_webhook_customer_subscription_updated(mocker):
    data = {'event_id': 'evt_00000000000000', 'event_type': 'customer.subscription.updated', 'stripe_id': 'sub_00000000000000', 'customer_id': 'cus_00000000000000',
            'current_period_start': 1519435009, 'current_period_end': 1521854209, 'canceled_at': 1519680008, 'days_until_due': None, 'default_payment_method': None,
            'plan_id': 'subhub-plan-api_00000000000000', 'plan_amount': 500, 'plan_currency': 'usd', 'plan_interval': 'month', 'status': 'canceled', 'trial_start': None,
            'trial_end': None, 'tax_percent': None, 'application_fee_percent': None, 'user_id': None}
    file_name = "customer/customer.subscription.updated.json"
    run_cutomer(mocker, data, file_name)


def test_stripe_webhook_customer_subscription_deleted(mocker):
    data = {'event_id': 'evt_00000000000000', 'event_type': 'customer.subscription.deleted', 'stripe_id': 'sub_00000000000000', 'customer_id': 'cus_00000000000000',
            'current_period_start': 1519435009, 'current_period_end': 1521854209, 'canceled_at': 1519680008, 'days_until_due': None, 'default_payment_method': None,
            'plan_id': 'jollybilling-plan-api_00000000000000', 'plan_amount': 500, 'plan_currency': 'usd', 'plan_interval': 'month', 'status': 'canceled', 'trial_start': None,
            'trial_end': None, 'tax_percent': None, 'application_fee_percent': None, 'user_id': None}
    file_name = "customer/customer.subscription.deleted.json"
    run_cutomer(mocker, data, file_name)
